...
item_1_quantity = Decimal(str(item_1_quantity)).quantize(Decimal('1'))
item_2_quantity = Decimal(str(item_2_quantity)).quantize(Decimal('1'))

item_1_price = Decimal(str(item_1_price)).quantize(Decimal('0.01'))
item_2_price = Decimal(str(item_2_price)).quantize(Decimal('0.01'))
...
all_quantity = Decimal(str(item_1_quantity)).quantize(Decimal('1')) + Decimal(str(item_2_quantity)).quantize(Decimal('1'))
all_cost = item_1_total_cost_right_format + item_2_total_cost_right_format
